  ...
  return (
    <section className="py-16 sm:py-20 px-4 sm:px-8 max-w-7xl mx-auto border-t border-[#F0E5D8]/15">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[11px] font-mono font-bold text-[#10B981] bg-[#10B981]/10 px-2.5 py-1 rounded-full border border-[#10B981]/20">
              100% Organique
            </span>
          </div>
          ...
          <div className="text-xs font-mono text-[#9DA4B0] font-semibold uppercase tracking-wider">
            Abonnés Qualifiés
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[11px] font-mono font-bold text-[#F0E5D8] bg-white/10 px-2.5 py-1 rounded-full border border-white/10">
              +14M / Mois
            </span>
          </div>
          <div className="text-3xl sm:text-4xl font-serif font-bold text-white mb-1">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[11px] font-mono font-bold text-[#F0E5D8] bg-[#F0E5D8]/10 px-2.5 py-1 rounded-full border border-[#F0E5D8]/30">
              3x Moyenne
            </span>
          </div>
          <div className="text-3xl sm:text-4xl font-serif font-bold text-white mb-1">
      ...
      <div className="bg-[#181A1D] rounded-3xl p-6 sm:p-8 border border-white/10 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
        ...
        <div className="flex flex-col items-center gap-1.5 p-3 border-y md:border-y-0 md:border-x border-white/10">
          <div className="flex items-center gap-2 text-sm font-bold text-[#F0E5D8]">
            <Zap className="w-4 h-4 text-[#F0E5D8]" />
        ...
        <div className="flex flex-col items-center gap-1.5 p-3">
          <div className="flex items-center gap-2 text-sm font-bold text-[#F0E5D8]">
            <Award className="w-4 h-4 text-[#F0E5D8]" />
